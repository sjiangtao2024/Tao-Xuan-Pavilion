...
staticRoutes.get("/modules/:filename", async (c) => {
  ...
  return c.text(`// Module file: ${filename}
// In development, this file should be served by Wrangler's static asset service.
// In production, it should be uploaded to R2 or served via CDN.
console.log("Module ${filename} loaded");`, 200, {
...
// .wrangler/tmp/bundle-gB63oe/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-gB63oe/middleware-loader.entry.ts
