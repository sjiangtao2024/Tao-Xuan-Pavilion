...
import { products, users, userProfiles, userAddresses, orders, orderItems, carts, cartItems, productMedia, mediaAssets, productTranslations, categories, categoryTranslations, adminLogs } from './db/schema';
import { and, eq, desc, count, or, lt } from 'drizzle-orm';
...
const app = new Hono<{ Bindings: Env, Variables: { userId: number, adminUser: any } }>();
